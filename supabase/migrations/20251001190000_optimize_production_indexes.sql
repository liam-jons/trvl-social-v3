...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_profiles_active_created
...
-- Vendor lookups
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_adventures_vendor_id
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_booking_payments_stripe_intent
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_connections_status_created
...
-- Community Feed
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_community_feed_user_id
  ON community_feed_items(user_id, created_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_community_feed_relevance
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_notification_settings_user_id
  ON notification_settings(user_id);

-- WhatsApp Integration
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_whatsapp_conversations_user_id
  ON whatsapp_conversations(user_id, last_message_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_whatsapp_messages_conversation_id
...
-- Vendor Management
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vendors_user_id
  ON vendors(user_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vendors_status
  ON vendors(vendor_status, created_at DESC);

-- Vendor Certifications
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vendor_certifications_vendor_id
  ON vendor_certifications(vendor_id, expiry_date)
  WHERE is_active = true;

-- Adventure Availability
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_adventure_availability_adventure_id
  ON adventure_availability(adventure_id, start_date);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_adventure_availability_dates
  ON adventure_availability(start_date, end_date)
  WHERE is_available = true;

-- Adventure Media
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_adventure_media_adventure_id
...
-- Groups
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_groups_owner_id
  ON groups(owner_id, created_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_groups_visibility
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_personality_traits
  ON personality_assessments(openness, conscientiousness, extraversion, agreeableness, neuroticism);

-- Compatibility Scores
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_compatibility_scores_user_id
  ON compatibility_scores(user_id, compatibility_score DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_compatibility_scores_target_user_id
  ON compatibility_scores(target_user_id, compatibility_score DESC);

-- Travel Preferences
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_travel_preferences_user_id
...
-- Stripe Integration
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_stripe_accounts_vendor_id
  ON stripe_accounts(vendor_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_stripe_accounts_stripe_account_id
  ON stripe_accounts(stripe_account_id)
  WHERE stripe_account_id IS NOT NULL;

-- Payment Splits (Group Bookings)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_payment_splits_booking_id
  ON payment_splits(booking_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_payment_splits_user_id
  ON payment_splits(user_id, payment_status);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_payment_splits_deadline
  ON payment_splits(payment_deadline)
  WHERE payment_status IN ('pending', 'overdue');

-- Invoices
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_invoices_vendor_id
...
-- Refunds & Disputes
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_refund_requests_booking_id
  ON refund_requests(booking_id, created_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_refund_requests_status
  ON refund_requests(status, created_at DESC)
  WHERE status IN ('pending', 'under_review');

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_dispute_cases_booking_id
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_content_reports_content_id
  ON content_reports(content_id, content_type);

-- Age Verification (COPPA Compliance)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_age_verification_logs_user_id
  ON age_verification_logs(user_id, verification_timestamp DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_age_verification_logs_status
  ON age_verification_logs(verification_status, verification_timestamp DESC);

-- Compliance Logs
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_compliance_logs_user_id
  ON compliance_logs(user_id, logged_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_compliance_logs_event_type
...
-- Engagement Metrics
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_engagement_metrics_user_id
  ON engagement_metrics(user_id, metric_date DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_engagement_metrics_date
  ON engagement_metrics(metric_date DESC);

-- User Activity Logs
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_activity_logs_user_id
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_content_views_user_id
...
-- Forum Categories
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_forum_categories_parent_id
  ON forum_categories(parent_category_id, display_order);

-- Forum Topics
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_forum_topics_category_id
...
-- Forum Posts
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_forum_posts_topic_id
